...
<<<<<<< HEAD
        ...
        {
            AbrirFormEnPanel2(new customers());
        }

        private void btnSuppliers_Click(object sender, EventArgs e)
        {
            AbrirFormEnPanel2(new Supplierscs());
        }

        private void طباعةسنداتToolStripMenuItem_Click(object sender, EventArgs e)
        {
            AbrirFormEnPanel2(new FormBuyBill());
        }
